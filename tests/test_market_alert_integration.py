"""Tests statiques de l'intégration des alertes dans market."""
import ast
...
FONCTION=next(n for n in ARBRE.body if isinstance(n,ast.FunctionDef) and n.name=="afficher_marche")
...
class MarketAlertIntegrationTests(unittest.TestCase):
